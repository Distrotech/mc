...
static gboolean
mc_keymap_cmd_switch_group (const gchar * event_group_name, const gchar * event_name,
...
gboolean
mc_keymap_process_group (const char *group, long pressed_keycode, void *data, GError ** error)
{
    ...
    ret_value = mc_event_raise (keymap_event->group, keymap_event->name, data);
